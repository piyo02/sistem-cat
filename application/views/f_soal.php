      ...
      <?php echo form_open_multipart(base_url()."adm/m_soal/simpan", "class='form-horizontal'"); ?>
          ...
          <div id="konfirmasi"></div>
            <div class="form-group fgsoal">
              <div class="col-md-2"><label>Jumlah Pilihan</label></div>
              <div class="col-md-10">
                <select class="form-control" name="jml_opsi" id="jml_opsi" required>
                  <?php 
                  if ($d['jml_opsi'] == '4') {
                    echo "<option value='5' >Soal 5 Pilihan</option>";
                    echo "<option value='4' selected>Soal 4 Pilihan</option>";
                  }
                  else {
                    echo "<option value='5' selected>Soal 5 Pilihan</option>";
                    echo "<option value='4' >Soal 4 Pilihan</option>";
                  }
                  ?>
                </select>
              </div>
            ...
            <div class="form-group fgsoal">
              <div class="col-md-2"><label>Mentor</label></div>
